...
export const ValidateLink: React.FC = () => {
  ...
  return (
    <div className="flex justify-center py-6 items-center min-h-full bg-stone-100">
      <div className="max-w-[764px] w-full px-8 mx-auto">
        {validationSuccess && data?.parsed_data ? (
          ...
          <div className="max-w-[700px] w-full px-8 py-12 bg-white rounded-lg shadow-lg rounded-xl mt-4 mx-auto">
            <div className="max-w-[550px] w-full flex flex-col justify-center items-center mx-auto">
